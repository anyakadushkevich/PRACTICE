...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->pictureBox1->Location = System::Drawing::Point(21, 71);
			this->pictureBox1->Name = L"pictureBox1";
			this->pictureBox1->Size = System::Drawing::Size(449, 319);
			...
			this->label1->Font = (gcnew System::Drawing::Font(L"Century Gothic", 10.2F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->label1->Location = System::Drawing::Point(97, 49);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(315, 19);
			this->label1->TabIndex = 2;
			this->label1->Text = L"мем-картинка \"хомяк со скрипкой\"";
			// 
			// Form2
			// 
			...
			this->ClientSize = System::Drawing::Size(482, 545);
